...
import com.spilna.tasklet.BatchTasklet;
...
public class BatchConfiguration {
	...
	public Job executeBatchJob(JobBuilderFactory jobBuilderFactory, Step step){
		return jobBuilderFactory.get("jobName").incrementer(new RunIdIncrementer()).flow(step).end().build();
	}
